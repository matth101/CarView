...
const LandingPage = () => {
	...
	return (
		<div className="relative min-h-screen overflow-hidden">
			...
			>
				<img src="/image.png" alt="Toyota" className="h-10" />
				<span className="text-white text-2xl font-black tracking-tight">TOYOTA</span>
			</motion.div>
								...
								>
									...
									{isHovered && (
										<motion.div
											...
											animate={{ opacity: 1, y: 0 }}
											className="absolute top-full mt-3 left-1/2 -translate-x-1/2 w-max bg-white text-gray-900 px-4 py-2 rounded-lg shadow-xl text-sm font-medium z-10"
										>
											{keyword.description}
